...
resource "aws_s3_bucket" "data_log_bucket" {
  ...
  tags = {
    git_commit           = "de412de5c515f150179040a23bf4e0c77dd7cb62"
    git_file             = "terraform/aws/s3.tf"
    git_last_modified_at = "2023-03-29 19:39:20"
    git_last_modified_by = "waciavarra@protonmail.com"
    git_modifiers        = "waciavarra"
    git_org              = "abjectnotfound"
    git_repo             = "terragoat"
    yor_trace            = "2cc752c5-0440-486f-9be5-5ae5ab97dcbd"
  }
}
